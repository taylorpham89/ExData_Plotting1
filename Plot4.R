plot1 <- function () {
  ...
  globalReact <- as.numeric(sorted_data$Global_reactive_power)
  Voltage <- as.numeric(sorted_data$Voltage)
  
  ##Create the parameter
  par(mfrow = c(2,2))
  
  plot(time, global, type="l", xlab="", ylab="Global Active Power")
  ...
  plot(time,globalReact, type="l", xlab="datetime", ylab="Global_reactive_power")
  ##save to png file
  dev.copy(png,"Plot4.png", width =550, height =500)
  dev.off()
}